...
case "$CASE" in
	(10070|12290|761) SYS=phx-72; CONF=nosave.conf;;
	(7445) SYS=phx-7445; CONF=nosave-7445.conf;;
...
ps aux | grep redis | ( grep -v grep && echo "Cannot shutdown redis server. Please kill it manually!" )
