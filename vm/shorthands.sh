...
export __ORBIT_IMAGE_FILE=$__ORBIT_ROOT_DIR/vm/phx.img
export __ORBIT_MOUNT_DIR=$__ORBIT_ROOT_DIR/vm/mountpoint
...
alias r='um; (mount | grep $__ORBIT_MOUNT_DIR) || $__ORBIT_ROOT_DIR/vm/run.sh'
# Force kill QEMU
